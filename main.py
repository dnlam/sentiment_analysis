...
# Your code here
data_test = (train_bow_features,train_labels ,test_bow_features, test_labels)
Ts = 25
Ls = 0.01
theta, theta_0 = p1.pegasos(train_bow_features, train_labels, Ts, Ls)
test_preds = p1.classify(test_bow_features, theta, theta_0)
test_accs = p1.accuracy(test_preds, test_labels)
print("Test accuracy is",test_accs)
